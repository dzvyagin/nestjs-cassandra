...
function getSchema(entity) {
  ...
  var _a = (0, decorator_utils_1.getOptions)(entity.prototype),
    instanceMethods = _a.instanceMethods,
    classMethods = _a.classMethods,
    options = __rest(_a, ['instanceMethods', 'classMethods']);

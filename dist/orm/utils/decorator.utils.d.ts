...
export declare function setEntity(target: any, entity: any): void;
export declare function getEntity(target: any): any;
...
export declare function addAttribute(target: any, name: string | symbol, options: any): void;
